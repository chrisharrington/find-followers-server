...
module.exports = function(user, tweets) {
    ...
    return Promise.all([
        require("./get-previous-followers")(user),
        require("./get-current-followers")(user),
        require("./get-favourites")(user)
    ]).spread(function(existingFollowers, currentFollowers, favourites) {
        return Promise.all(_.map(require("./build-followers")(existingFollowers, currentFollowers, favourites), function(follower) {
